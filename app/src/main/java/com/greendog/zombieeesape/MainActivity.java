package com.greendog.zombieeesape;
...
public class MainActivity extends ActionBarActivity {
	...
	public void UpdateScene(int goesto){
		...
		switch (goesto){
			//Start Scene
			case 0: newbackground = getResources().getIdentifier("@drawable/start", "drawable", this.getPackageName());
					...
					break;
			//No Water Scene
			case 1: newbackground = getResources().getIdentifier("@drawable/aspirin", "drawable", this.getPackageName());
					setText(getString(R.string.No_Water));
					setButton1(4,getString(R.string.Bathroom_Water));
					setVisibilities(true,true,false,false);
					break;
			//Phone
			case 2: newbackground = getResources().getIdentifier("@drawable/checkphone2", "drawable", this.getPackageName());
					setButton1(5,getString(R.string.Check_Window));
					setText(getString(R.string.Sirens));
					setVisibilities(true,true,false,false);
					break;
			//Check TV
			case 3: newbackground = getResources().getIdentifier("@drawable/checktv", "drawable", this.getPackageName());
					setButton1(5,getString(R.string.No_Signal));
					setText(getString(R.string.Sirens));
					setVisibilities(true,true,false,false);
					break;
			//Go To Bathroom
			case 4: newbackground = getResources().getIdentifier("@drawable/gotobathroomtogetwater", "drawable", this.getPackageName());
					...
					break;
			//Window
			case 5: newbackground = getResources().getIdentifier("@drawable/checkwindow", "drawable", this.getPackageName());
					setButton1(8,getString(R.string.Take_Peek_Should));
					setVisibilities(false,true,false,false);
					break;
			//First Death Scene
			case 6:	newbackground = getResources().getIdentifier("@drawable/deathscene", "drawable", this.getPackageName());
					switch (deathToken){
						...
						case 2: setText(getString(R.string.Tom_Not_Happy));
							break;
						case 3: if (hasRacket){setText(getString(R.string.Not_Fast_Enough));}
			...
			case 7: newbackground = getResources().getIdentifier("@drawable/gobackintoroom", "drawable", this.getPackageName());
					setText(getString(R.string.Sirens));
					setButton1(5,getString(R.string.Check_Window));
					setVisibilities(true,true,false,false);
					break;
			//Outside the window
			case 8: newbackground = getResources().getIdentifier("@drawable/takeapeek", "drawable", this.getPackageName());
					setText(getString(R.string.Ambulance));
					setButton1(9,getString(R.string.Look_Around_Room));
					setVisibilities(true,true,false,false);
					break;
			//Choosing What to Take
			case 9: newbackground = getResources().getIdentifier("@drawable/gobackintoroom", "drawable", this.getPackageName());
					...
					break;
			//Choice Made
			case 10: newbackground = getResources().getIdentifier("@drawable/gobackintoroom", "drawable", this.getPackageName());
					setText(getString(R.string.Kick_Zombie_Butt));
					setButton1(11,getString(R.string.Go_Outside_Room));
					setVisibilities(true,true,false,false);
					break;
			//Outside Room
			case 11: newbackground = getResources().getIdentifier("@drawable/hallwayzombieattacks", "drawable", this.getPackageName());
			...
			case 12: newbackground = getResources().getIdentifier("@drawable/gotobathroomtogetwater", "drawable", this.getPackageName());
			...
			case 13: newbackground = getResources().getIdentifier("@drawable/continuedownthehallway", "drawable", this.getPackageName());
					...
					break;
			//Check On Tom
			case 14: newbackground = getResources().getIdentifier("@drawable/friendnextdoor", "drawable", this.getPackageName());
					setText(getString(R.string.Better_Get_Going));
					setButton1(17,getString(R.string.Check_It_Out));
					setVisibilities(true,true,false,false);
					break;
			//Elevator
			case 15: newbackground = getResources().getIdentifier("@drawable/elevator", "drawable", this.getPackageName());
					...
					break;
			//Stairs
			case 16: newbackground = getResources().getIdentifier("@drawable/stairs", "drawable", this.getPackageName());
					...
					break;
			//Tom Attacks
			case 17: newbackground = getResources().getIdentifier("@drawable/checkitout", "drawable", this.getPackageName());
			...
			case 18: newbackground = getResources().getIdentifier("@drawable/lobby", "drawable", this.getPackageName());
					setText(getString(R.string.Unstoppable));
					setButton1(20,getString(R.string.To_Lobby));
					setVisibilities(true,true,false,false);
					break;
			//Killed Tom
			case 19: newbackground = getResources().getIdentifier("@drawable/friendnextdoor", "drawable", this.getPackageName());
					setText(getString(R.string.World_Come_To));
					setButton1(13,getString(R.string.Continue_Hallway));
					setVisibilities(true,true,false,false);
					break;
			//Hear Joyce Screaming Outside Study Lounge
			case 20: newbackground = getResources().getIdentifier("@drawable/studylounge", "drawable", this.getPackageName());
					...
					break;
			//Key works
			case 21: newbackground = getResources().getIdentifier("@drawable/joyceintrouble", "drawable", this.getPackageName());
					setText(getString(R.string.Key_Fits));
					setButton1(22,getString(R.string.Ditch_Her));
					if (hasRacket){setButton2(23,getString(R.string.Save_Her));}
					else{setButton2(6,getString(R.string.Save_Her));}
					deathToken = 4;
					setVisibilities(true,true,true,false);
					break;
			//Outside
			case 22: newbackground = getResources().getIdentifier("@drawable/panic", "drawable", this.getPackageName());
			...
			case 23: newbackground = getResources().getIdentifier("@drawable/joycejoinstheteam", "drawable", this.getPackageName());
					setText(getString(R.string.Joyce_Joins));
					setButton1(24,getString(R.string.To_Dining_Hall));
					setVisibilities(true,true,false,false);
					break;
			//Radio Scene
			case 24: newbackground = getResources().getIdentifier("@drawable/radioroom2", "drawable", this.getPackageName());
					setText(getString(R.string.Radio_Announce));
					setButton1(25,getString(R.string.Keep_Listening));
					setVisibilities(true,true,false,false);
					break;
			case 25: newbackground = getResources().getIdentifier("@drawable/radioroom2", "drawable", this.getPackageName());
					setText(getString(R.string.Radio_More));
					setButton1(0,getString(R.string.Play_Again));
                    setButton2(0,getString(R.string.Go_to_Level_2));
                    setButton3(26,getString(R.string.Exit_the_game));
					setVisibilities(true,true,true,true);
					break;
            // Exit the Game
            case 26: newbackground = getResources().getIdentifier("@drawable/hallwayzombieattacks", "drawable", this.getPackageName());
                setText(getString(R.string.See_You));
                setVisibilities(true,true,false,false);
			...
			default:
                newbackground = getResources().getIdentifier("@drawable/jellyfish", "drawable", this.getPackageName());
		...
		main.setBackgroundResource(newbackground);
	}
